...
// // default function for whole ATM Task 
// const atmFunc = () => {
//     reqAmountINPUT = document.getElementById("reqAmountINPUT").value;
//     reqAmountINPUT = Number(reqAmountINPUT)
//     prefer = document.getElementById("ReqPrefer").value;
//     prefer = Number(prefer);
//     noofPrefer = null;
...
//         newfor.innerHTML = `${notesarray[i]} No of Notes : ${noofPrefer} <br> Balance Amount ${reqAmountINPUT}`
//         fordiv.appendChild(newfor);
//     } else {
//         qty = Math.floor(reqAmountINPUT / notesarray[i])
//         reqAmountINPUT -= qty * notesarray[i];
//         let fordiv = document.getElementById("context");
